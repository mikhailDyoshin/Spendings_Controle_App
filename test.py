...
""" 
    Here described the future functionality 
    of the Spengings-Control-App. 
    It's waiting to be embedded.
"""
...
class Data():
    ...
    def __init__(self, data, fields):
        ...
        # The plot
        self.plotImg = self.plot(self.lastDatesSorted, self.dictForPlot)
...
# print_list(lastDatesSorted)

# print_list(lastDataSorted)

# print_dict(dictForPlot)

# plot(lastDatesSorted, dictForPlot)